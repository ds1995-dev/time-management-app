...
<div class="attendance-list-page">
    <section class="attendance-list" aria-label="勤怠一覧">
        ...
        <div class="attendance-list__month-nav">
            <a href="{{ url('/attendance/list?month=' . $prevMonth) }}" class="attendance-list__nav-link">← 前月</a>
            <form method="GET" action="{{ route('attendance.list', ['id' => auth()->id()]) }}" class="attendance-list__picker-form">
                <input
                    id="month"
                    type="month"
                    name="month"
            ...
            <a href="{{ url('/attendance/list?month=' . $nextMonth) }}" class="attendance-list__nav-link">翌月 →</a>
        </div>
                ...
                <tbody>
                    ...
                    @endphp
                        <tr>
                            ...
                            <td>{{ $attendance->break_total ? \Carbon\Carbon::parse($attendance->break_total)->format('H:i') : '' }}</td>
                            <td>{{ $attendance->work_total ? \Carbon\Carbon::parse($attendance->work_total)->format('H:i') : '' }}</td>

                            <td><a href="{{ route('attendance.detail', ['id' => $attendance->id]) }}" class="attendance-table__detail">詳細</a></td>
                        </tr>
                        @endforeach
                </tbody>
            </table>
